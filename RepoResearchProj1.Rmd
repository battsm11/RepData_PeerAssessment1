...
Dataset: [link](https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2Factivity.zip)Activity Monitoring Data [52K]
...
#1) load in data from working directory
...
hist(summary_act$daily_step_count, main= "Histogram of steps per day", xlab = "Range of daily step totals",
     ylab = "Number of days in Range", col= heat.colors(7), ylim= c(0,30))
...
So we see there is more activity on the weekdays than on the weekends.